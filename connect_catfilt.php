...
<body>
    ...
    echo "<div class='nav'>";
        echo "<div class='pages'>";
            echo "<a href='home.html'><strong>Home</strong></a><br>";
            echo "<a href='calendar.html'>Calendar</a><br>";
            echo "<a href='checklist.html'>CheckList</a><br>";
            echo "<a href='entertainment.html'>Entertainment</a><br>";
