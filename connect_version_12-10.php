...
.profile-content {
    ...
    */
    ...
    .toggle-sidebar {
        ...
        margin: 0;
        padding: 10px;
        background-color: #DCD0FF; /* Match the background color of the navbar */
...
echo "<div class='nav'>";
            echo "<a href='https://taskbird01-a292729c6ec9.herokuapp.com/home.html' class='logoBox'>";
                echo "<img class='logo' src='https://felixzsong8.github.io/TaskBird/TaskBird.png' id='logo'></img>";
            echo "</a>";
            echo "<div class='pages'>";
                echo "<a href='https://taskbird01-a292729c6ec9.herokuapp.com/home.html'><i class='fa fa-fw fa-home'></i><strong>Home</strong></a>";
                echo "<a href='https://taskbird01-a292729c6ec9.herokuapp.com/index.html'><i class='fa fa-fw fa-calendar'></i>Calendar</a>";
                echo "<a href='https://felixzsong8.github.io/TaskBird/checklist.html'><i class='fa fa-fw fa-check-square-o'></i>CheckList</a>";
                echo "<a href='https://yvonnel.sgedu.site/final_proj/connect.php'><i class='fa fa-fw fa-user'></i>Connect</a>";
            echo "</div>";
        echo "</div>";
    
    //echo "<button class='toggle-sidebar' onclick='toggleSidebar()'>☰</button>";
    ...
    echo "<h1 style='margin-bottom: -3%'>Connect</h1>";
